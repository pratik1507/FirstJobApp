...
public class ReviewController {
	...
	public ResponseEntity<String> updateReview(@PathVariable Long companyId, @PathVariable Long reviewId, @RequestBody Review reivew){
		boolean isReviewUpdated = reviewService.updateReview(companyId, reviewId, reivew);
		if(isReviewUpdated)
